...
namespace EternityEngine
{
    ...
    public class ArtCanvas : UpdateWhileEnabled
    {
...
#if UNITY_EDITOR
        /// Pass a GameObject to receive the newly-created ArtCanvas.
        /// Useful for unit tests that need some access to a Canvas but don't
        /// want to set up all of Tilt Brush.
        public static ArtCanvas UnitTestSetUp(GameObject container)
        {
            var ret = container.AddComponent<ArtCanvas>();
            // There are instances of ArtCanvas in the scene, and I don't want to
        ...
        {
            UnityEngine.Object.DestroyImmediate(container.GetComponent<ArtCanvas>());
        }
#endif
