...
namespace EternityEngine
{
	public class Stroke : StrokeData
	{
		...
		public ArtCanvas m_IntendedCanvas;
		...
		public SketchGroupTag Group
		{
			...
			set
			{
				...
				SelectionHandler.instance.OnStrokeRemovedFromGroup(this, oldGroup);
				SelectionHandler.instance.OnStrokeAddedToGroup(this);
			}
		}
		...
		public void Recreate(TrTransform? leftTransform = null, ArtCanvas canvas = null)
		{
		...
		public void CopyGeometry(ArtCanvas targetCanvas, Stroke baseStroke)
		{
			if (m_Type != Type.NotCreated)
			{
		...
		/// be parented to an arbitrary Transform, only to ArtCanvas.
		public void SetParent(ArtCanvas canvas)
		{
			ArtCanvas prevCanvas = Canvas;
		...
		/// Directly analagous to Transform.SetParent, except strokes may not
		/// be parented to an arbitrary Transform, only to ArtCanvas.
		public void SetParentKeepWorldPosition(ArtCanvas canvas, TrTransform? leftTransform = null)
		{
			ArtCanvas prevCanvas = Canvas;
			if (prevCanvas == canvas)
			{
