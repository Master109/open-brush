...
namespace EternityEngine
{
    public class BatchManager
    {
        ...
        List<BatchPool> m_Pools;
        Dictionary<Guid, BatchPool> m_BrushToPool;
        Bounds m_MeshBounds;
        ArtCanvas m_owner;
        Transform m_ParentTransform;
        List<string> m_MaterialKeywords = new List<string>();
        int m_CurrentTimestamp;
        static Dictionary<ushort, Batch> sm_BatchMap = new Dictionary<ushort, Batch>();
        public ArtCanvas Canvas { get { return m_owner; } }
        ...
        public void Init(ArtCanvas owner)
        {
