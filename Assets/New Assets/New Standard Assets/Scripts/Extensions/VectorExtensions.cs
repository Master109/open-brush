...
namespace Extensions
{
	public static class VectorExtensions
	{
		...
		public static Vector3Int ToVec3Int (this Vector3 v, MathfExtensions.RoundingMethod roundingMethod = MathfExtensions.RoundingMethod.HalfOrLessRoundsDown)
		{
		...
		public static Vector3Int ToVec3Int (this Vector2 v, MathfExtensions.RoundingMethod roundingMethod = MathfExtensions.RoundingMethod.HalfOrLessRoundsDown)
		{
			return new Vector3Int(MathfExtensions.RoundToInt(v.x, roundingMethod), MathfExtensions.RoundToInt(v.y, roundingMethod), 0);
		}

		public static Vector2Int ToVec2Int (this Vector2 v, MathfExtensions.RoundingMethod roundingMethod = MathfExtensions.RoundingMethod.HalfOrLessRoundsDown)
		{
			return new Vector2Int(MathfExtensions.RoundToInt(v.x, roundingMethod), MathfExtensions.RoundToInt(v.y, roundingMethod));
		}

		public static Vector2Int ToVec2Int (this Vector3 v, MathfExtensions.RoundingMethod roundingMethod = MathfExtensions.RoundingMethod.HalfOrLessRoundsDown)
		{
			return new Vector2Int(MathfExtensions.RoundToInt(v.x, roundingMethod), MathfExtensions.RoundToInt(v.y, roundingMethod));
		}
		...
		public static int[] ToArray (this Vector2Int v)
		{
