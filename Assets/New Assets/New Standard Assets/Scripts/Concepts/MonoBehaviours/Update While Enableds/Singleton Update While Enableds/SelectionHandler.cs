...
{
    public class SelectionHandler : SingletonUpdateWhileEnabled<SelectionHandler>
    {
        public SelectionWidget m_SelectionWidget;
        ...
        Dictionary<SketchGroupTag, HashSet<Stroke>> m_GroupToStrokes =
            new Dictionary<SketchGroupTag, HashSet<Stroke>>();
        Dictionary<SketchGroupTag, HashSet<GrabWidget>> m_GroupToWidgets =
        ...
        // selected.
        Dictionary<SketchGroupTag, HashSet<Stroke>> m_GroupToSelectedStrokes =
            new Dictionary<SketchGroupTag, HashSet<Stroke>>();
        Dictionary<SketchGroupTag, HashSet<GrabWidget>> m_GroupToSelectedWidgets =
            new Dictionary<SketchGroupTag, HashSet<GrabWidget>>();
        ...
        HashSet<Stroke> m_SelectedStrokes;
        HashSet<Stroke> m_SelectedStrokesCopyWhileGrabbingGroup;

        // The list of widgets currently selected.
        HashSet<GrabWidget> m_SelectedWidgets;
        HashSet<GrabWidget> m_SelectedWidgetsCopyWhileGrabbingGroup;

        bool m_IsAnimatingTossFromGrabbingGroup;
        bool m_IsGrabbingGroup;
        BaseTool.ToolType m_ToolTypeBeforeGrabbingGroup;
        ...
        bool m_RemoveFromSelection;

        bool m_bSelectionWidgetNeedsUpdate;
        ...
        bool ShouldShowSelectedStrokes
        {
            get
            {
    ...
    if (PointerManager.m_Instance.SymmetryPlane_RS is Plane plane_RS) {
      flipPlaneInSelectionSpace = App.Scene.SelectionCanvas.Pose.inverse * plane_RS;
        ...
        void RemoveFromGroupToSelectedStrokes(SketchGroupTag group, Stroke stroke)
        {
        ...
        void RemoveFromGroupToSelectedWidgets(SketchGroupTag group, GrabWidget widget)
        {
        ...
        void AddToGroupToSelectedStrokes(SketchGroupTag group, Stroke stroke)
        {
        ...
        void AddToGroupToSelectedWidgets(SketchGroupTag group, GrabWidget widget)
        {
        ...
        void OnSelectionTransformed(TrTransform xf_SS)
        {
