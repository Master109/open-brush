...
namespace EternityEngine
{
    ...
    public class ArtScene : MonoBehaviour
    {
        ...
        public delegate void ActiveCanvasChangedEventHandler(
            ArtCanvas prev, ArtCanvas current);

        public ArtCanvas m_MainCanvas;
        public ArtCanvas m_SelectionCanvas;

        bool m_bInitialized;
        Light[] m_Lights;

        ArtCanvas m_ActiveCanvas;
        List<ArtCanvas> m_LayerCanvases;
        ...
        /// Emits SceneScript.PoseChanged, ArtCanvas.PoseChanged.
                ...
                if (value != m_ActiveCanvas)
                {
                    ...
                    if (ActiveCanvasChanged != null)
                    {
                        ...
                        OutputWindowScript.m_Instance.CreateInfoCardAtController(
                            TiltBrush.InputManager.ControllerName.Brush,
        ...
        public ArtCanvas MainCanvas { get { return m_MainCanvas; } }
        public ArtCanvas SelectionCanvas { get { return m_SelectionCanvas; } }

        public IEnumerable<ArtCanvas> AllCanvases
        {
            get
            {
        ...
        public void Init()
        {
            ...
            m_bInitialized = true;
            m_LayerCanvases = new List<ArtCanvas>();
        ...
        public ArtCanvas Test_AddLayer()
        {
            ...
            if (Config.IsExperimental)
            {
                ...
                var layer = go.AddComponent<ArtCanvas>();
                m_LayerCanvases.Add(layer);
                ArtModule.Scene.ActiveCanvas = layer;
                return layer;
            }
#endif
            return null;
